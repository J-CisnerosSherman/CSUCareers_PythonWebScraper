...
def search_job_list():
    ...
    data = {
        ...
        'campusList': ['1'],              #['1'],                    # Campus number if 1 = Bakersfield (if None means no campus selected returns all campuses)
        'jobposted': '0',                      # it only works with 0,10,20 increment of 10 no other days work
