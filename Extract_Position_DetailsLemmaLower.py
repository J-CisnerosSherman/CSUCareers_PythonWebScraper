...
def review_date(sublist1, sublist2, sublist3):
    ...
    if sublist1:
        ...
        print("matches found in 1 before",matches1)
        matches1B = filter_matches(matches1)

        print("matches date 1",matches1B)
        ...
        if matches1:
            ...
            for match_id, start, end in matches1B:             # get the first match of the corresponding pattern
                ...
                span_doc1 = doc1[end:end_index]
                print("span doc 1bb date",span_doc1)
    ...
    if my_list:
        ...
        if matches:
            ...
            for doc_sub in sub_docs_to_check:  #for each doc that was formed from the new line tokens
                ...
                matcher3 = Matcher(nlp.vocab)
                matcher3.add("Phone Number", [pattern2])
