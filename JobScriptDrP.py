...
def get_job_details(job):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            #description is type string 
            

            #Parse text here and return 
            #find_chair(description)
...
if results:
    for job in results:
        ...
        #tHIS IS WHERE TO CALL THE FUNCTION TO PARSE THE TEXT FROM OTHER FILE 
