...
def get_job_details(job):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("TTTEEXXTTT ext content ",description) 
...
if results:
    for job in results:
        ...
        update_job_dt(job)
        # the output will look like  {'PositionID': 102150, 'datePosted': '2/22/2023', 'closingDate': 
        # #'Open Until Filled', 'jobTitle': 'Education/Library Science (23/24 SSE 15)', 'apptType': 
        # 'Tenure-Track', 'location': 'Bakersfield', 'jobType': '1'}

        print("Printing the dam job " ,job)
        ...
        print("it was added to  job dic", job)  #This is where dictionary is complete 
        ...
        dictionary6 = CleanScript1.parse_text(texttoparse)
        job.pop('Description')
